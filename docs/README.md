...
###### <a href="javascript:window.open('https://www.energybot.ml/addbot', 'Add the bot', 'width=500,height=600')">Add the bot</a> | [Join the support server](https://discord.gg/mnNjC9k)
## Commands
### General Commands
<table>
  <tr>
